...
const Publications = () => {
  ...
  const imageUrl =
    "https://blockchain.ubc.ca/sites/default/files/styles/hero_focal_point_325/public/landing-page-images/inaki-del-olmo-602632-unsplash.jpg?h=0e00dd96&itok=CBuvGU8R";
      ...
      <ol className="list-decimal pl-10 md:ml-[50px] md:max-w-[1100px] md:pb-10">
        {publication.map((data) => (
          <li key={data.id} className="p-2">
            ...
            <Link to={`/singlePublication/${data._id}`} target="_blank">
              {data.title}
            </Link>{" "}
            <a
