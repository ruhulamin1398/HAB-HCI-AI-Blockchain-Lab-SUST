            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed">
                  Discover the Future at SUST HCI, AI & Blockchain Research Lab
                  (HAB), where we fuse Human-Computer Interaction, Artificial
                  Intelligence, and Blockchain to shape the digital landscape.
                </p>
