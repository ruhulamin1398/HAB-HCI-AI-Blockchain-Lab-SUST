            ...
            <div className="bg-white p-8 rounded-lg shadow-md max-w-2xl w-full">
                ...
                <div className="relative overflow-hidden pb-[60%]">
                    {Paper.length > 0 && Paper[0].File && (
                        <a href={`data:application/pdf;base64,${arrayBufferToBase64(Paper[0].File.data)}`} download="certificate.pdf">
                            <object
                                data={`data:application/pdf;base64,${arrayBufferToBase64(Paper[0].File.data)}`}
